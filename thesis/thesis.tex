% ----------------------------------------------------------------------
%                   LATEX TEMPLATE FOR Ph.D. THESIS
% ----------------------------------------------------------------------

% based on Harish Bhanderi's Ph.D./MPhil template, then Uni Cambridge
% http://www-h.eng.cam.ac.uk/help/tpl/textprocessing/ThesisStyle/
% corrected and extended in 2007 by Jakob Suckale, then MPI-CBG Ph.D. program
...
\begin{filecontents*}[overwrite]{\jobname.xmpdata}
       \Title{Latent Variable Augmentation for Approximate Bayesian Inference - Applications for Gaussian Processes}
       \Author{Théo Galy-Fajou}
       \Keywords{Gaussian Process\sep Bayesian Inference\sep Approximate Inference}
       \Language{en-US}
       \Subject{Ph.D. of Théo Galy-Fajou}
\end{filecontents*}

\documentclass[twoside,11pt,online,a4paper,pdfa2,custommargin,numbered,customfont]{PhDthesisTUB}
...
% 
%  On Windows, the package cm-super has to be installed!
%
% `' :  computer modern
% `fontA' :  newtxmath
% `fontB' :  cmbright
...
%
% `custom font': Use `customfont' option in the document class and load the
...
\include{chapters/Preamble/preamble}
 
\definecolor{sb1}{rgb}{0.00392156862745098,0.45098039215686275,0.6980392156862745}
\definecolor{sb2}{rgb}{0.8705882352941177,0.5607843137254902,0.0196078431372549}
...
\include{chapters/0_frontmatter/zusammenfassung}
\include{chapters/0_frontmatter/abstract}

%: ----------------------- tie in front matter ------------------------

%\frontmatter
\include{chapters/0_frontmatter/dedication}
\include{chapters/0_frontmatter/acknowledgement}
...
%\printglossary
%\printnomenclature[\include{acronyms}1.5cm] % [] = distance between entry and description
%\printglossery
...
\cfchapter{Background\label{ch:background}}{./chapters/2_background}{chapter2_background}
\cfchapter{Efficient Gaussian Process Classification Using P\'olya-Gamma Data Augmentation\label{ch:classification}}{./chapters/3_classification}{chapter3_classification}
\cfchapter{Multi-Class Gaussian Process Classification Made Conjugate: Efficient Inference via Data Augmentation\label{ch:multi-class}}{./chapters/4_multiclass}{chapter4_multiclass}
\cfchapter{Automated Augmented Conjugate Inference for Non-conjugate Gaussian Process Models\label{ch:general}}{./chapters/5_general}{chapter5_general}
\cfchapter{Flexible and Efficient Inference with Particles for the Variational Gaussian Approximation\label{ch:gpf}}{./chapters/7_gpf}{chapter7_gpf.tex}
\cfchapter{Discussions and extensions\label{ch:discussion}}{./chapters/8_discussions}{discussion}
\cfchapter{Conclusion\label{ch:conclusion}}{./chapters/9_conclusion}{conclusion}
\cleardoublepage
...
% Entries are also linked back to the page number in the text and to the external URL if provided in the BibTex file.
...
\include{chapters/Appendix1/appendix1}
\end{appendices}
