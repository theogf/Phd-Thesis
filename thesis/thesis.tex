...
\cfchapter{Multi-Class Gaussian Process Classification Made Conjugate: Efficient Inference via Data Augmentation\label{ch:multiclass}}{./chapters/4_multiclass}{chapter4_multiclass}
