...
\documentclass[twoside,11pt,online,a4paper,pdfa1,custommargin,numbered,biblatex,customfont]{PhDthesisTUB}
...
\bibliography{chapters/9_backmatter/references} % adjust this to fit your BibTex file
\fi
\end{footnotesize}
