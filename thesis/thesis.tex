...
\cfchapter{Flexible and Efficient Inference with Particles for the Variational Gaussian Approximation \label{ch:chapter6}}{./chapters/6_gpf}{chapter6_gpf.tex}
