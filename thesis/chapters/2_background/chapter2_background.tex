...
\mycom{the integral is not enough}
...
When new inputs $\bx_*$ are distant from the training data $\bX$, the predictive uncertainty will be high.\mycom{to clarify}
...
The Fisher information matrix is a Riemannian metric which gives the direction of the steepest descent with respect to the \ac{KL} divergence.
\mycom{Give more details about the meaning of the Fisher info}
...
\end{align*}
\mycom{maybe be more explicit about this}
