...
If using a conjugate likelihood is not possible, a relaxation is to have all full-conditionals in closed-form, we talk then about \textbf{conditionally conjugate} models.
...
% Another canonical sampling approach for \ac{GPs} is \ac{ESS} .
% It is a variation of the standard random walk approach where instead of a taking a step in a random direction, the proposal is tried in various direction until a sample is accepted.
