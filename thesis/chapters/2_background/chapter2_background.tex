...
For one-dimensional inputs ($D=1$), solutions exist using state-space models representation, leading to a $\mathcal{O}(N)$ complexity but higher-dimensional problems require alternative solutions.
\cite{csato2002sparse} proposed first to use a subset of points and create an approximation
