...
\mycom{talk about exchangeability}
...
The main one is to identify potential augmentations in a given model and to compute lengthy derivations to arrive at the right result.
The idea generalization of using \ac{MGF} is promising but is also limited.
Often we need to rearrange terms and use special identities.
This is feasible for someone with expertise, but automatizing the process is complicated.
