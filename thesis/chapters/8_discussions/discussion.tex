...
Then, injecting the optimal distributions, we can derive the optimal $\bmu_f^*$ and $\bSigma_f^*$, all obtainable in closed-form.

This double-bound approach is very similar to \citet{lazaro-gredillaVariationalHeteroscedasticGaussian}, although they are using the exponential link and need some extra computations.
