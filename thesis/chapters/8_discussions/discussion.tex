...
However, as underlined in Section~\ref{sec:cavi}, the \ac{CAVI} updates need the full-conditionals of the model, and the marginalizing one of them does not guarantee to get correct updates.
