...
Following the binary classification problem, a natural extension was to extend the problem to the multi-class classification problem.
By drawing inspiration from \citet{donner2018efficient}, new augmentations methods are used to circumvent the problem of a much more complex likelihood function.
More specifically a new link: the logistic-softmax function is developed and after three successive augmentations to a fully conditionally-conjugate model.
