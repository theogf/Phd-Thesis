...
\documentclass[twoside,11pt,online,a4paper,pdfa1,custommargin,numbered,biblatex]{PhDthesisTUB}
...
\cfchapter{Background}{2_background}{chapter2_background}
\tikzsetexternalprefix{./3_classification/TikzPictures/}
\cfchapter{Efficient Gaussian Process Classification Using Polya-Gamma Data Augmentation\label{ch:chapter3}}{3_classification}{chapter3_classification}
\tikzsetexternalprefix{./4_multiclass/TikzPictures/}
\cfchapter{Multi-Class Gaussian Process Classification Made Conjugate: Efficient Inference via Data Augmentation\label{ch:chapter4}}{4_multiclass}{chapter4_multiclass}
\tikzsetexternalprefix{./5_general/TikzPictures/}
\cfchapter{Automated Augmented Conjugate Inference for Non-conjugate Gaussian Process Models\label{ch:chapter5}}{5_general}{chapter5_general}
\tikzsetexternalprefix{./6/TikzPictures/}
\cfchapter{Variational Gaussian Particle Flow\label{ch:chapter6}}{6_gpf}{chapter6_gpf.tex}
